...
|----------------|--------------------------|-------|
| `0.2.0` | `2.4.0+` | Recommended version; includes breaking query, wrapper, and type-metadata API changes |
