import{a as m}from"./chunk-Z4J7AABF.js";import{a as p}from"./chunk-HZ2SEKHW.js";import"./chunk-OE4G5TB3.js";import{a as h}from"./chunk-4FO7WJ36.js";import{a as l}from"./chunk-LVHT47OW.js";import{F as x}from"./chunk-LWH7SIW3.js";import{Pb as t,jc as o,kc as r,ra as c,xb as i}from"./chunk-TLBD5JYT.js";import{a as g,b as d,g as f}from"./chunk-ODN5LVDJ.js";var k=f(x());var C={title:"Quick Start",mdFile:"./index.md",category:m,order:1,imports:[p],demos:{AnimateLogoComponent:p}},n=C;var j=[];var v={AnimateLogoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> {
...
</span><span class="line ngde">## Using Kronos:
</span><span class="line ngde">
</span><span class="line ngde">\`\`\`kotlin group=<span class="hljs-string ngde">"Kronos"</span> name=<span class="hljs-string ngde">"Kronos.kt"</span>
</span><span class="line ngde"><span class="hljs-keyword ngde">val</span> director: Director = Director(
...
</span></code></pre></ng-doc-tab>`,b=(()=>{let s=class s extends l{constructor(){super(),this.routePrefix="",this.pageType="guide",this.pageContent=w,this.page=n,this.demoAssets=u}};s.\u0275fac=function(e){return new(e||s)},s.\u0275cmp=c({type:s,selectors:[["ng-doc-page-en-getting-started-quick-start"]],standalone:!0,features:[o([{provide:l,useExisting:s},j,n.providers??[]]),i,r],decls:1,vars:0,template:function(e,T){e&1&&t(0,"ng-doc-page")},dependencies:[h],encapsulation:2,changeDetection:0});let a=s;return a})(),D=[d(g({},(0,k.isRoute)(n.route)?n.route:{}),{path:"",component:b,title:"Quick Start"})],N=D;export{b as DynamicComponent,N as default};
