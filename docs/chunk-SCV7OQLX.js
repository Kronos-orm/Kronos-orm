...
</span></code></pre>`}]},u=f;var b=`<h1 id="\u5FEB\u901F\u4E0A\u624B" class="ngde">\u5FEB\u901F\u4E0A\u624B<a title="Link to heading" class="ng-doc-header-link ngde" href="/zh-CN/getting-started/quick-start#\u5FEB\u901F\u4E0A\u624B"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h1><ng-doc-demo componentname="AnimateLogoComponent" indexable="false" class="ngde"><div id="options" class="ngde">{"container":false}</div></ng-doc-demo><h2 id="\u6DFB\u52A0\u4F9D\u8D56" class="ngde">\u6DFB\u52A0\u4F9D\u8D56\uFF1A<a title="Link to heading" class="ng-doc-header-link ngde" href="/zh-CN/getting-started/quick-start#\u6DFB\u52A0\u4F9D\u8D56"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h2><p class="ngde">\u4EC5\u9700\u5F15\u5165<code class="ngde">kronos-core</code>\u6A21\u5757\u548C<code class="ngde">kronos-compiler-plugin</code>\u63D2\u4EF6\u5373\u53EF\u5728\u60A8\u7684\u9879\u76EE\u4E2D\u4F7F\u7528Kronos\u3002</p><ng-doc-tab group="import" name="gradle(kts)" icon="gradlekts" class="ngde"><pre class="ngde hljs"><code class="hljs language-kotlin code-lines ngde" lang="kotlin" name="" icon="" highlightedlines="[]"><span class="line ngde">    dependencies {
</span><span class="line ngde">        implementation(<span class="hljs-string ngde">"com.kotlinorm.kronos-core:2.0.0"</span>) <span class="hljs-comment ngde">// \u4F9B\u4E86\u57FA\u7840\u7684ORM\u529F\u80FD</span>
</span><span class="line ngde">    }
</span><span class="line ngde">    
</span><span class="line ngde">    plugins {
</span><span class="line ngde">        id(<span class="hljs-string ngde">"com.kotlinorm.kronos-gradle-plugin"</span>) version <span class="hljs-string ngde">"2.0.0"</span> <span class="hljs-comment ngde">// \u63D0\u4F9B\u4E86\u7F16\u8BD1\u65F6\u652F\u6301</span>
</span><span class="line ngde">    }
...
</span><span class="line ngde">        implementation 'com.kotlinorm:kronos-core:2.0.0' // \u4F9B\u4E86\u57FA\u7840\u7684ORM\u529F\u80FD
</span><span class="line ngde">    }
</span><span class="line ngde">    
</span><span class="line ngde">    plugins {
</span><span class="line ngde">        id 'com.kotlinorm.kronos-gradle-plugin' version '2.0.0' // \u63D0\u4F9B\u4E86\u7F16\u8BD1\u65F6\u652F\u6301
</span><span class="line ngde">    }
</span></code></pre></ng-doc-tab><ng-doc-tab group="import" name="maven" icon="maven" class="ngde"><pre class="ngde hljs"><code class="hljs language-xml code-lines ngde" lang="xml" name="" icon="" highlightedlines="[]"><span class="line ngde"><span class="hljs-comment ngde">&#x3C;!--\u5C06\u63D2\u4EF6\u6DFB\u52A0\u5230\u60A8\u7684pom.xml\u6587\u4EF6\u4E2D\uFF1A--></span>
</span><span class="line ngde"><span class="hljs-comment ngde">&#x3C;!--\u6709\u5173\u8BE6\u7EC6\u4FE1\u606F\uFF0C\u8BF7\u53C2\u8003[https://kotlinlang.org/docs/all-open-plugin.html#maven]\u3002--></span>
</span><span class="line ngde"><span class="hljs-tag ngde">&#x3C;<span class="hljs-name ngde">project</span>></span>
</span><span class="line ngde">    <span class="hljs-comment ngde">&#x3C;!--kronos-core\u63D0\u4F9B\u4E86\u57FA\u7840\u7684ORM\u529F\u80FD--></span>
...
</span><span class="line ngde">                        <span class="hljs-comment ngde">&#x3C;!--kronos-maven-plugin\u63D0\u4F9B\u4E86\u7F16\u8BD1\u65F6\u652F\u6301--></span>
