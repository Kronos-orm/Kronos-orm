...
</span></code></pre></ng-doc-tab><h3 id="2-postgresql\u6570\u636E\u5E93\u8FDE\u63A5\u914D\u7F6E" class="ngde">2. PostgreSQL\u6570\u636E\u5E93\u8FDE\u63A5\u914D\u7F6E<a title="Link to heading" class="ng-doc-header-link ngde" href="/en/database/connect-to-db#2-postgresql\u6570\u636E\u5E93\u8FDE\u63A5\u914D\u7F6E"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h3><ng-doc-tab group="PostgreSQL" name="gradle(kts)" icon="gradlekts" class="ngde"><pre class="ngde hljs"><code class="hljs language-kotlin code-lines ngde" lang="kotlin" name="" icon="" highlightedlines="[]"><span class="line ngde">dependencies {
</span><span class="line ngde">    implementation(<span class="hljs-string ngde">"org.apache.commons:commons-dbcp2:latest.release"</span>)
...
</span></code></pre></ng-doc-tab><h3 id="3-oracle\u6570\u636E\u5E93\u8FDE\u63A5\u914D\u7F6E" class="ngde">3. Oracle\u6570\u636E\u5E93\u8FDE\u63A5\u914D\u7F6E<a title="Link to heading" class="ng-doc-header-link ngde" href="/en/database/connect-to-db#3-oracle\u6570\u636E\u5E93\u8FDE\u63A5\u914D\u7F6E"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h3><ng-doc-tab group="Oracle" name="gradle(kts)" icon="gradlekts" class="ngde"><pre class="ngde hljs"><code class="hljs language-kotlin code-lines ngde" lang="kotlin" name="" icon="" highlightedlines="[]"><span class="line ngde">dependencies {
</span><span class="line ngde">    implementation(<span class="hljs-string ngde">"org.apache.commons:commons-dbcp2:latest.release"</span>)
...
</span></code></pre></ng-doc-tab><h3 id="5-sqlite\u6570\u636E\u5E93\u8FDE\u63A5\u914D\u7F6E" class="ngde">5. SQLite\u6570\u636E\u5E93\u8FDE\u63A5\u914D\u7F6E<a title="Link to heading" class="ng-doc-header-link ngde" href="/en/database/connect-to-db#5-sqlite\u6570\u636E\u5E93\u8FDE\u63A5\u914D\u7F6E"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h3><ng-doc-tab group="SQLite" name="gradle(kts)" icon="gradlekts" class="ngde"><pre class="ngde hljs"><code class="hljs language-kotlin code-lines ngde" lang="kotlin" name="" icon="" highlightedlines="[]"><span class="line ngde">dependencies {
</span><span class="line ngde">    implementation(<span class="hljs-string ngde">"org.apache.commons:commons-dbcp2:latest.release"</span>)
...
</span></code></pre></ng-doc-tab>`,f=(()=>{let s=class s extends l{constructor(){super(),this.routePrefix="",this.pageType="guide",this.pageContent=y,this.page=n,this.demoAssets=j}};s.\u0275fac=function(e){return new(e||s)},s.\u0275cmp=g({type:s,selectors:[["ng-doc-page-en-database-connect-to-db"]],standalone:!0,features:[i([{provide:l,useExisting:s},m,n.providers??[]]),d,t],decls:1,vars:0,template:function(e,S){e&1&&o(0,"ng-doc-page")},dependencies:[r],encapsulation:2,changeDetection:0});let a=s;return a})(),I=[c(p({},(0,x.isRoute)(n.route)?n.route:{}),{path:"",component:f,title:"Connect to DB"})],M=I;export{f as DynamicComponent,M as default};
