...
class KronosPluginTest {
    ...
    fun `plugin accepts dump-ir parameter`() {
        val result = compile(
            ...
            pluginOptions = listOf(
                PluginOption("kronos-compiler-plugin-k2", "dump-ir", "true")
            )
        )
    ...
    fun `plugin accepts dump-ir-path parameter`() {
        val result = compile(
            ...
            pluginOptions = listOf(
                PluginOption("kronos-compiler-plugin-k2", "dump-ir", "true"),
                PluginOption("kronos-compiler-plugin-k2", "dump-ir-path", "build/test-ir-dump")
            )
        )
    ...
    fun `plugin accepts dump-ir-mode kotlinLike`() {
        val result = compile(
            ...
            pluginOptions = listOf(
                PluginOption("kronos-compiler-plugin-k2", "dump-ir", "true"),
                PluginOption("kronos-compiler-plugin-k2", "dump-ir-mode", "kotlinLike")
            )
        )
    ...
    fun `plugin accepts dump-ir-mode common`() {
        val result = compile(
            ...
            pluginOptions = listOf(
                PluginOption("kronos-compiler-plugin-k2", "dump-ir", "true"),
                PluginOption("kronos-compiler-plugin-k2", "dump-ir-mode", "common")
            )
        )
    ...
    fun `plugin accepts dump-ir-files parameter`() {
        val result = compile(
            ...
            pluginOptions = listOf(
                PluginOption("kronos-compiler-plugin-k2", "dump-ir", "true"),
                PluginOption("kronos-compiler-plugin-k2", "dump-ir-files", "Test.kt,User.kt")
            )
        )
    ...
    fun `plugin accepts dump-ir-files with wildcard pattern`() {
        val result = compile(
            ...
            pluginOptions = listOf(
                PluginOption("kronos-compiler-plugin-k2", "dump-ir", "true"),
                PluginOption("kronos-compiler-plugin-k2", "dump-ir-files", "*Service.kt,*Repository.kt")
            )
        )
