...
class KPojoFieldMetadataBoxTest : AbstractKronosJvmBoxSuite("kpojoFieldMetadata") {
     ...
     */
    @Test
    fun strategyDisableMetadata() = box("strategyDisableMetadata")
     ...
     */
    @Test
    fun defaultIgnoreRules() = box("defaultIgnoreRules")

    /**
     * Verifies richer column metadata including primary-key variants and cascade exclusion.
     */
    @Test
    fun richColumnMetadata() = box("richColumnMetadata")

    /**
     * Verifies inferred KColumnType metadata for Kotlin and Java field types.
     */
    @Test
    fun inferredColumnTypeMatrix() = box("inferredColumnTypeMatrix")
}
