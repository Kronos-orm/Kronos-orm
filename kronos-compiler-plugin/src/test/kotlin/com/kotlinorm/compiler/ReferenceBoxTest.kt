...
class ReferenceBoxTest : AbstractKronosJvmBoxSuite("reference") {
    ...
    /**
     * Verifies listOf and arrayOf property-reference forms.
     */
    @Test
    fun referenceCollectionForms() = box("referenceCollectionForms")

    /**
     * Verifies setOf, mutableListOf, and cast property-reference extraction.
     */
    @Test
    fun referenceCastAndSetForms() = box("referenceCastAndSetForms")
