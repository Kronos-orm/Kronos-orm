...
// Verifies that exists(query) lowers to SQL Criteria carrying a deferred selectable query ref.
...
fun existsWhere(user: ExistsUser, block: ToFilter<ExistsUser, Boolean?>): Criteria? {
...
fun box(): String {
    ...
    val criteria = existsWhere(ExistsUser(id = 7)) {
    ...
    val failures = listOfNotNull(
        ...
        expect(subqueryValue?.not == false) { "exists not flag was ${subqueryValue?.not}" },
