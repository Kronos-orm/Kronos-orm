...
// Verifies `[field1, field2] in query` lowers to syntax row-value IN subquery.
...
fun tupleWhere(user: TupleUser, block: ToFilter<TupleUser, Boolean?>): SqlExpr? {
...
fun box(): String {
    ...
    val condition = tupleWhere(TupleUser(id = 7, status = 1)) {
