...
class RecordingWrapper : KronosDataSourceWrapper {
    ...
    override fun forList(
        ...
        return listOf(QueryTypeUser(1, "Ada"))
    }
...
fun expectInjectedCall(call: QueryTypeCall?, kind: String): String? {
    return when {
        ...
        call.kind != kind -> "Fail: $kind call kind was ${call.kind}"
        call.kClass != QueryTypeUser::class -> "Fail: $kind kClass was ${call.kClass}"
        !call.isKPojo -> "Fail: $kind isKPojo was ${call.isKPojo}"
        "com.kotlinorm.interfaces.KPojo" !in call.superTypes -> "Fail: $kind superTypes were ${call.superTypes}"
        else -> null
    }
}
