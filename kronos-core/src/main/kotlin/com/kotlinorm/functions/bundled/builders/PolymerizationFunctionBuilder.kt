...
object PolymerizationFunctionBuilder : FunctionBuilder {
    ...
    override fun transform(field: FunctionField, dataSource: KronosDataSourceWrapper): String {
        ...
        return buildFields(field.functionName, field.name, field.fields, dataSource)
    }
}