...
class SelectFrom5<T1: KPojo, T2: KPojo, T3: KPojo, T4: KPojo, T5: KPojo>(
    override var t1: T1,
    var t2: T2, var t3: T3, var t4: T4, var t5: T5
) : SelectFrom<T1>(t1) {
    ...
    override var listOfPojo: MutableList<KPojo> = mutableListOf(t1, t2, t3, t4, t5)
