...
This section describes the cascading updates for one-to-one cascading relationships defined in Kronos.
...
{{$.keyword("advanced/cascade", ["Cascade relationship definition", "Use delegation to implement cascading many-to-many cross-intermediate table relationships"] )}}.
