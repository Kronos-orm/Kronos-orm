...
KPojo provides the `@Cascade` annotation to define the cascade relationship, see: {{ $.keyword("mapping/annotations", ["annotation configuration", "@Cascade cascade relationship definition"]) }}.
