...
- 🔧 Add example-project smoke tests for Ktor, Spring Boot, and Solon, publish current artifacts to Maven local in CI, and update examples for the current metadata API ([#240](https://github.com/Kronos-orm/Kronos-orm/pull/240)).
