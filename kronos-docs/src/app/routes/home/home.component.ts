...
export class HomeComponent implements OnInit, OnDestroy {
    ...
    readonly dbLogos = ['MySQL', 'PostgreSQL', 'SQLite', 'Oracle', 'SQL Server', 'DB2', 'Sybase', 'H2', 'OceanBase', 'DM8', 'GaussDB'];
    ...
    readonly stages: Stage[] = [
        {
            ...
            code: [
                '@Table("tb_movie")',
                '@TableIndex("idx_name", ["name"], Mysql.KIndexType.UNIQUE)',
                'data class Movie(',
            ...
            docPath: 'class-definition/table-class-definition'
        },
        {
            key: 'Operate',
            eyebrow: {
            ...
            docPath: 'database/database-operation'
        },
        {
            key: 'Query',
            eyebrow: {
            ...
            docPath: 'database/select-records'
        },
        {
            key: 'Integrate',
            eyebrow: {
            ...
            copy: {
                zh: 'Kronos 支持 MySQL、PostgreSQL、SQLite、Oracle、SQL Server 等数据库，可与 Spring Boot、Ktor、Vert.x、Solon、Android 项目集成。',
                en: 'Kronos supports MySQL, PostgreSQL, SQLite, Oracle, SQL Server and more, with integration paths for Spring Boot, Ktor, Vert.x, Solon and Android.'
            },
            bullets: [
            ...
            docPath: 'plugin/datasource-wrapper-and-third-part-framework'
        }
    ];
    ...
    readonly capabilities: Capability[] = [
        {
            ...
            copy: {
                zh: '构建期生成映射代码，运行时避免反射调用，启动更快、内存占用更低、GC 压力更小。',
                en: 'Mapping code is generated during build, avoiding runtime reflection for faster startup, lower memory usage and less GC pressure.'
            },
            docPath: 'getting-started/benchmark'
        },
        {
            label: '02',
            ...
            docPath: 'concept/where-having-on-clause'
        },
        {
            label: '03',
            title: {zh: '多数据库支持', en: 'Multi-database support'},
            copy: {
                zh: 'MySQL、PostgreSQL、SQLite、Oracle、SQL Server、DB2、H2、OceanBase、DM8、GaussDB 等。',
                en: 'MySQL, PostgreSQL, SQLite, Oracle, SQL Server, DB2, H2, OceanBase, DM8, GaussDB and more.'
            },
            docPath: 'plugin/database-support'
        },
        {
            label: '04',
            ...
            docPath: 'advanced/cascade-defination'
        },
        {
            label: '05',
            ...
            docPath: 'concept/common-strategy'
        },
        {
            label: '06',
    ...
    readonly docsEntries: Entry[] = [
        ...
        },
        {
            ...
            docPath: 'ai/using-kronos-with-ai'
        }
    ];
    ...
    get databaseOperationUrl(): string {
        return this.docRoute('database/database-operation');
    }

    get advancedUrl(): string {
        return this.docRoute('advanced/some-locks');
    }

    get pluginUrl(): string {
        return this.docRoute('plugin/datasource-wrapper-and-third-part-framework');
    }
}
