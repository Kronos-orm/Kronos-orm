...
class SqlSyntaxValidatorExpressionTraversalTest {
    ...
    fun traversesEveryExpressionShape() {
        ...
        val expressions = listOf(
            ...
            SqlExpr.Window(
                expr = SqlExpr.GeneralFunc(name = "SUM", args = listOf(col("amount"))),
                window = SqlWindow(
            ...
            SqlExpr.GeneralFunc(name = "MAX", args = listOf(col("age")), orderBy = orderBy, withinGroup = orderBy, filter = col("active")),
