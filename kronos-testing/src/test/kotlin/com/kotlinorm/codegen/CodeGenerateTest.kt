...
class CodeGenerateTest {
    ...
    fun createTempDir() {
        ...
        configPath = File(tempDir, "testConfig.toml").apply {
            ...
            writeTomlContent(
                ...
                username = "${System.getenv("MYSQL_USERNAME").orEmpty()}"
                password = "${System.getenv("MYSQL_PASSWORD").orEmpty()}"
    ...
    fun testCodegen() {
        ...
        assertEquals("import com.kotlinorm.annotations.NonNull", lines[8])
