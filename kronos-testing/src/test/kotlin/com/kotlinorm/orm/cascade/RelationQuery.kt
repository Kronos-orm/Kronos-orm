...
class RelationQuery {
    ...
    fun testCascadeInsert() {
        ...
        val school = School(
            id = 1, name = "School", groupClass = [
                GroupClass(
                    id = 11, name = "一年级", students = [
    ...
    fun testRevertSelect() {
        ...
        val groupClass = GroupClass(name = "一年级", students = [student])
        val school = School(name = "School", groupClass = [groupClass])
