          ...
          [
            {
              items: [
                ...
                {label: 'CLASS_DEFINITION', icon: 'pi pi-search', subtext: 'SUBTEXT_OF_CLASS_DEFINITION'},
                {label: 'DATABASE_OPERATION', icon: 'pi pi-user', subtext: 'SUBTEXT_OF_DATABASE_OPERATION'}
              ]
            }
          ],
          [
          ...
          [
            {
              items: [{
                ...
                label: 'GET_START',
                subtext: 'GET_START',
                routerLink: ['/documentation/getting-started/quick-start']
              }]
            }
          ]
        ]
